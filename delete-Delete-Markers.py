...
# This script is available as fair use for users.
...
This Script will take the following inputs:
 ...
 prompt to delete the delete markers.
"""
...
if __name__ == '__main__':
    ...
    while not delete_flag:
        choice = input("$ Do you wish to proceed and remove the delete markers? [y/n]")
